...
%   If P='J' the Jacobi method is used, if P='G' the Gauss-Seidel
%   method is selected. Otherwise, P is a N-by-N matrix that play
%   the role of a preconditioner. TOL specifies the tolerance of the
%   method. The method stops when the relative residual ||r^k||/||b|| falls
%   below TOL.
...
if (niter >= nmax)
    ...
    disp(sprintf('\n itermeth converged in %i iterations.',niter));
end